...
```json
{
  ...
  "bsGitRepository" : "github.com?owner=mgbrodi&repo=hello-java",
  "bsGitBranch" : "main"
}
```
## Log
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->hello-java]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=mgbrodi&repo=hello-java'
